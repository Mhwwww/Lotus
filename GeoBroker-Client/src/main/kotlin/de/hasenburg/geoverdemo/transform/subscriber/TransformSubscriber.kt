...
class TransformSubscriber(private val loc: Location, private val topic: Topic) {
    private val logger = LogManager.getLogger()
    ...
    fun run() {
        ...
        val client = SimpleClient("localhost", 5559, identity = " TransformSub_${topic.topic}_${loc.point}_${Random.nextInt()}")
...
suspend fun main() {
    ...
    locations.forEach{
        GlobalScope.launch {
            val newS = TransformSubscriber(it, subscriberTopic)
